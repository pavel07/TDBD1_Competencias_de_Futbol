...
BEGIN
  FOR reg in cEQUIPO LOOP
    PIPE ROW(T_EQUIPO_ROW(reg.ID_EQUIPO,reg.ID_CIUDAD,reg.ID_ENTRENADOR,reg.NOMBRE,reg.FECHA_FUNDACION,reg.NUMERO_COPASGANADAS,reg.LOGOTIPO));
  END LOOP;
  RETURN;
END;
...
(
  ...
  PENALES_GOLES_EQUIPO1, 
  PENALES_GOLES_EQUIPO2, 
  TARJETAS_A_EQUIPO1, 
  TARJETAS_A_EQUIPO2, 
  TARJETAS_R_EQUIPO1, 
  TARJETAS_R_EQUIPO2
