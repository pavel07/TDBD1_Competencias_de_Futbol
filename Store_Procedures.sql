...
CREATE OR REPLACE PROCEDURE SP_EQUIPO_INSERT (  pID_CIUDAD EQUIPO.ID_CIUDAD%TYPE,
                                                ...
                                                pTIPO EQUIPO.TIPO%TYPE)IS
BEGIN
  INSERT INTO EQUIPO(ID_CIUDAD,ID_ENTRENADOR,NOMBRE,FECHA_FUNDACION,NUMERO_COPASGANADAS,LOGOTIPO,TIPO)
  VALUES(pID_CIUDAD,pID_ENTRENADOR,pNOMBRE,pFECHA_FUNDACION,pNUMERO_COPASGANADAS,pLOGOTIPO,pTIPO);
  COMMIT;
END;
...
CREATE OR REPLACE PROCEDURE SP_COMPETENCIA_ESTADIO_INSERT ( pID_COMPETENCIA COMPETENCIA_ESTADIO.ID_COMPETENCIA%TYPE,
                                                            pID_ESTADIO COMPETENCIA_ESTADIO.ID_ESTADIO%TYPE)IS
BEGIN
  INSERT INTO COMPETENCIA_ESTADIO (ID_COMPETENCIA, ID_ESTADIO)
  VALUES ( pID_COMPETENCIA, pID_ESTADIO);
  COMMIT;
END;

CREATE OR REPLACE PROCEDURE SP_COMPETENCIA_PAIS_INSERT (    pID_COMPETENCIA COMPETENCIA_PAIS.ID_COMPETENCIA%TYPE,
                                                            pID_PAIS COMPETENCIA_PAIS.ID_PAIS%TYPE)IS
BEGIN
  INSERT INTO COMPETENCIA_PAIS (ID_COMPETENCIA, ID_PAIS)
  VALUES ( pID_COMPETENCIA, pID_PAIS);
  COMMIT;
END;

CREATE OR REPLACE PROCEDURE SP_EQUIPO_COMPETENCIA_INSERT (  pID_EQUIPO EQUIPO_COMPETENCIA.ID_EQUIPO%TYPE,
                                                            pID_COMPETENCIA EQUIPO_COMPETENCIA.ID_COMPETENCIA%TYPE,
                                                            pPUNTOS EQUIPO_COMPETENCIA.PUNTOS%TYPE,
                                                            pPOSICION EQUIPO_COMPETENCIA.POSICION%TYPE)IS
BEGIN
  INSERT INTO EQUIPO_COMPETENCIA (ID_EQUIPO,ID_COMPETENCIA,PUNTOS,POSICION)
  VALUES ( pID_EQUIPO,pID_COMPETENCIA,pPUNTOS,pPOSICION);
  COMMIT;
END;

CREATE OR REPLACE PROCEDURE SP_EQUIPO_JUGADOR_INSERT (  pID_EQUIPO EQUIPO_JUGADOR.ID_EQUIPO%TYPE,
                                                        pID_JUGADOR EQUIPO_JUGADOR.ID_JUGADOR%TYPE,
                                                        pNUMERO_CAMISOLA EQUIPO_JUGADOR.NUMERO_CAMISOLA%TYPE)IS
BEGIN
  INSERT INTO EQUIPO_JUGADOR (ID_EQUIPO,ID_JUGADOR,NUMERO_CAMISOLA)
  VALUES ( pID_EQUIPO,pID_JUGADOR,pNUMERO_CAMISOLA);
  COMMIT;
END;
...
CREATE OR REPLACE PROCEDURE SP_COMPETENCIA_ESTADIO_DELETE ( pID_COMPETENCIA COMPETENCIA_ESTADIO.ID_COMPETENCIA%TYPE,
                                                            pID_ESTADIO COMPETENCIA_ESTADIO.ID_ESTADIO%TYPE)IS
BEGIN
  DELETE FROM COMPETENCIA_ESTADIO WHERE ID_COMPETENCIA = pID_COMPETENCIA AND ID_ESTADIO = pID_ESTADIO;
  COMMIT;
END;

CREATE OR REPLACE PROCEDURE SP_COMPETENCIA_PAIS_DELETE (  pID_COMPETENCIA COMPETENCIA_PAIS.ID_COMPETENCIA%TYPE,
                                                          pID_PAIS COMPETENCIA_PAIS.ID_PAIS%TYPE)IS
BEGIN
  DELETE FROM COMPETENCIA_PAIS WHERE ID_COMPETENCIA = pID_COMPETENCIA AND ID_PAIS = pID_PAIS;
  COMMIT;
END;

CREATE OR REPLACE PROCEDURE SP_EQUIPO_COMPETENCIA_DELETE (  pID_EQUIPO EQUIPO_COMPETENCIA.ID_EQUIPO%TYPE,
                                                            pID_COMPETENCIA EQUIPO_COMPETENCIA.ID_COMPETENCIA%TYPE)IS
BEGIN
  DELETE FROM EQUIPO_COMPETENCIA WHERE ID_EQUIPO = pID_EQUIPO AND ID_COMPETENCIA = pID_COMPETENCIA;
  COMMIT;
END;

CREATE OR REPLACE PROCEDURE SP_EQUIPO_JUGADOR_DELETE (  pID_EQUIPO EQUIPO_JUGADOR.ID_EQUIPO%TYPE,
                                                        pID_JUGADOR EQUIPO_JUGADOR.ID_JUGADOR%TYPE)IS
BEGIN
  DELETE FROM EQUIPO_JUGADOR WHERE ID_EQUIPO = pID_EQUIPO AND ID_JUGADOR = pID_JUGADOR;
  COMMIT;
END;
...
CREATE OR REPLACE PROCEDURE SP_EQUIPO_UPDATE (  pID_CIUDAD EQUIPO.ID_CIUDAD%TYPE,
                                                ...
                                                pNUMERO_COPASGANADAS EQUIPO.NUMERO_COPASGANADAS%TYPE,
                                                pLOGOTIPO EQUIPO.LOGOTIPO%TYPE,
                                                pID_EQUIPO EQUIPO.ID_EQUIPO%TYPE,
                                                pTIPO EQUIPO.TIPO%TYPE)IS
BEGIN
